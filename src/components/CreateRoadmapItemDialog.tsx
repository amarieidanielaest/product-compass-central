...
interface CreateRoadmapItemDialogProps {
  ...
  defaultType?: 'strategic' | 'delivery';
}

const CreateRoadmapItemDialog = ({ 
  open, 
  onOpenChange, 
  onItemCreated, 
  defaultType = 'delivery' 
}: CreateRoadmapItemDialogProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newItem = {
      ...
      ...(formData.type === 'strategic' ? {
        deliverables: 0,
        capacity: { allocated: 0, required: 100 },
        risks: [],
        metrics: {}
      } : {
        feedback: { count: 0, sentiment: 'neutral' },
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Create {isStrategic ? 'Strategic Initiative' : 'Delivery Item'}</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 pt-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.type} onValueChange={(value: 'strategic' | 'delivery') => setFormData(prev => ({ ...prev, type: value }))}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="strategic">Strategic Initiative</SelectItem>
                <SelectItem value="delivery">Delivery Feature/Epic</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <Button type="submit">
              Create {isStrategic ? 'Initiative' : 'Item'}
            </Button>
          </div>
        </form>
      </DialogContent>
...
export default CreateRoadmapItemDialog;