...
import { Plus, Webhook, Edit, Trash2, TestTube, Play, AlertCircle, CheckCircle2, Clock } from 'lucide-react';
    ...
    try {
      ...
      const mockWebhooks: WebhookConfig[] = [
        ...
        },
        {
          ...
          headers: { 'Content-Type': 'application/json' },
          payload_template: DEFAULT_PAYLOAD_TEMPLATES.discord,
          is_active: false,
            ...
            <Tabs defaultValue="basic" className="w-full">
              ...
              <TabsContent value="payload" className="space-y-4">
                ...
                <div className="text-xs text-muted-foreground">
                  <p>Available variables: {'{{event_type}}'}, {'{{title}}'}, {'{{description}}'}, {'{{timestamp}}'}, {'{{data}}'}</p>
                </div>
              </TabsContent>
            </Tabs>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p>{webhook.last_triggered ? new Date(webhook.last_triggered).toLocaleDateString() : 'Never'}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
